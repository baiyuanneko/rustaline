...
#[openapi(
    ...
    paths(
        ...
        handlers::captcha::get_captcha_config,
        handlers::captcha::get_pow_challenge,
        handlers::captcha::get_image_captcha,
    ...
    components(schemas(
        ...
        dto::PowSolution,
        dto::CaptchaConfigResponse,
        dto::PowConfigInfo,
        dto::ImageCaptchaConfigInfo,
        dto::PowChallengeResponse,
        dto::ImageCaptchaResponse,
        dto::CommentPublicResponse,
        dto::CommentThreadRoot,
        dto::CommentThreadResponse,
        dto::CommentRepliesResponse,
    ...
    tags(
        ...
        (name = "captcha", description = "评论验证码（PoW / 图形码，匿名）"),
